  ...
  return (
    <footer className="relative z-10 bg-midnight_text dark:bg-semidark">
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="md:col-span-4 col-span-12 flex items-center px-4 sm:px-0">
            <Link href="/" className="mb-6 inline-block max-w-40">
              <Image
                src={getImgPath("/images/logo/02.png")}
                alt="logo"
                width={156}
                height={38}
          ...
          <div className="md:col-span-8 col-span-12 grid grid-cols-12 gap-4 px-4 sm:px-0">
            ...
            <div className="w-full lg:col-span-4 col-span-12">
              ...
              <ul>
                ...
                <li>
                  <Link href="/about" className="mb-3 inline-block text-base text-gray hover:text-white">
                    About Us
                  </Link>
                </li>
                {/* <li>
                ...
                <li>
                  <Link href="/signin" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Admin
                  </Link>
                </li>
              </ul>
            ...
            <div className="w-full lg:col-span-4 col-span-12">
              ...
              <ul>
                <li onClick={() => updateFilter('category', 'apartment')}>
                  <Link href="/business/gajera-infratech" className="mb-3 inline-block text-base text-gray hover:text-white">
                    Gajera Infratech
                  </Link>
                </li>
      ...
      <div className="border-t border-border dark:border-dark_border py-8">
        <div className="container flex flex-col lg:flex-row justify-center items-center mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="border-t border-border dark:border-dark_border py-4">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <p className="text-center text-gray text-sm">
            Developed by{" "}
            <a
              href="https://www.bluesyncsoftwares.com"
              target="_blank"
